    ...
    <Container maxW="container.xl" p={5}>
      <VStack spacing={5}>
        ...
        <Flex w="full" wrap="wrap" gap={10}>
          {/* Main Chat Interface */}
          <Box w={{ base: "full", md: "65%" }} p={8} borderWidth="1px" borderRadius="lg" bg="gray.100">
            <VStack spacing={4}>
              <Box w="full" h="500px" p={3} overflowY="auto" borderWidth="1px" borderRadius="lg" bg="gray.50">
                {/* Chat messages would appear here */}
              </Box>
              <Textarea placeholder="Enter your message here..." />
              <Button leftIcon={<FaPlus />} _hover={{ bg: "blue.500", color: "white" }}>
                Send Message
              </Button>
            </VStack>
          </Box>
          ...
          <Box w="full" p={5} borderWidth="1px" borderRadius="lg">
            <VStack spacing={4}>
              <Heading as="h3" size="lg" fontSize="2xl">
                Past Chats
              </Heading>
              <Menu>
